...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', type=str, default='../Data/RoboCup/Finetune/test/', help='path to dataset')
    parser.add_argument('--config_path', type=str, default='config/robo-down-small.cfg', help='path to model config file')
    parser.add_argument('--weights_path', type=str, default='checkpoints/bestFinetunePruned.weights', help='path to weights file')
